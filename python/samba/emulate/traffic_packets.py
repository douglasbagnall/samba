...
from samba.dcerpc import security, drsuapi, misc, nbt, lsa, drsblobs, netlogon, ntlmssp
from samba.dcerpc.netlogon import netr_WorkstationInformation
from samba.dcerpc.security import dom_sid
from samba.dcerpc.lsa import LSA_POLICY_VIEW_LOCAL_INFORMATION
...
def packet_samr_25(packet, conversation, context):
    ...
    rids = s.QueryGroupMember(c.group_handle)
    return True
